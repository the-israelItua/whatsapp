...
import groupAvatar from "assets/images/women.jpeg";
    ...
    <div className="profile">
      ...
      <div className="profile__section profile__section--media">
        <div className="sb profile__heading-wrapper">
          ...
          <button>
            <RightArrowIcon className="profile__heading-icon" />
          </button>
        </div>
      ...
      <div className="profile__section profile__section--danger">
        <BlockIcon className="profile__danger-icon" />
        <p className="profile__danger-text"> Block </p>
      </div>

      <div className="profile__section profile__section--danger">
        <ThumbsDownIcon className="profile__danger-icon" />
        <p className="profile__danger-text"> Report contact </p>
      </div>

      <div className="profile__section profile__section--danger">
        <DeleteIcon className="profile__danger-icon" />
